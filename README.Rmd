...
>
>- ADMG (acyclic directed mixed graph), projection of a directed acyclic graphs (DAG) with latent variables. This can be based on expert knowledge, causal discovery methods, or a combination of both.
