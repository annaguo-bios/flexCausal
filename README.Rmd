...
- `truncate_lower` and `truncate_upper` specify the lower and upper bounds to truncate $p(A=a\mid X)$, for <a href="https://www.codecogs.com/eqnedit.php?latex=a%20\in%20%7B0%2C1%7D" target="_blank">
  $a \in \{0, 1\}$
</a>. This helps avoid extreme values of the estimated propensity score.
